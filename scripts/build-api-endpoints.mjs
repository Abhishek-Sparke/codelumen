...
// Read problemTestCasesRegistry.ts and extract the PROBLEM_TEST_CASES_REGISTRY object
// Or import it via dynamic import / tsx
import { PROBLEM_TEST_CASES_REGISTRY } from '../src/data/problemTestCasesRegistry.js';
...
console.log('Successfully generated api/code/run.ts and api/code/submit.ts with all 75 problems and zero cross-problem fallbacks!');
